...
<body >
	<div id="bigWrapper">
		...
		<div class="content" style="margin: 0 auto; width:100%;">
			<p style="margin-top: -30px; width: 100%; font-weight: bold; font-size: 22px; text-align: center; margin-bottom: 30px;">Laporan Data Pembelian</p>
            <table style="width: 100%;">
                ...
                <?php $i = 1; foreach($detailPembelian as $rowp): ?>
                <tr>
            		<td><?= $i++ ?></td>
